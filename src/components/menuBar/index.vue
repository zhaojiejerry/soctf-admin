    ...
    <el-dialog
      ...
      <el-form ref="passForm" :model="passForm" :rules="passRules" label-width="90px" label-position="right" class="pass-form">
        <el-form-item label="原密码：" prop="oldPass">
          <el-input type="password" show-password size="small" :maxlength="16" v-model="passForm.oldPass" placeholder="请输入原密码" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item id="loginStateone" label="新密码：" prop="newPass">
          <el-input type="password" size="small" :maxlength="16" @blur="loginblurState"  @focus="changeFocus" v-model="passForm.newPass" placeholder="请输入新密码" autocomplete="off"></el-input>
          <div v-if="loginFocusState" class="el-form-item__tips">8-16位数字、字母、符号的组合，且至少使用其中两种</div>
        </el-form-item>
        <el-form-item label="确认密码：" prop="confirmPass">
          <el-input type="password" size="small" :maxlength="16" v-model="passForm.confirmPass" placeholder="请确认新密码" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
    ...
    <el-dialog
      ...
      <div class="sign-input">
        <div class="input-suffix">
          ...
          <el-input size="small" placeholder="请输入值班医生姓名" :maxlength="10" v-model="signForm.doctorName" />
        </div>
        <div class="input-suffix">
          <span class="input-title">医院名称：</span>
          <el-input size="small" placeholder="请输入医院名称" :maxlength="20"  v-model="signForm.hospitalName" />
        </div>
      </div>
      <div class="sign-container">
        <div class="sign-one">
          ...
          <div class="upload-area" @mouseenter="enterUserSign = true">
            ...
            <div class="float-layer" v-if="enterUserSign && signForm.userSign" @mouseleave="enterUserSign = false">
        ...
        <div class="sign-one">
          ...
          <div class="upload-area" @mouseenter="enterHospitalSign = true">
            <input class="file-upload" type="file" id="hospitalSign" accept="image/png, image/jpeg, image/jpg" @change="uploadImg($event, 'hospitalSign')"/>
            <img v-if="signForm.hospitalSign" :src="signForm.hospitalSign" />
            <label v-else for="hospitalSign" class="upload-content"><i class="el-icon-plus"></i></label>
            <div class="float-layer" v-if="enterHospitalSign && signForm.hospitalSign" @mouseleave="enterHospitalSign = false">
