  ...
  <div style="height: 100%;">
    ...
    <el-card class="box-card">
      ...
      <div class="user-child-list">
        <el-table :header-cell-style="{background:'#f7f7f7', color:'#333333', fontWeight: 'bold'}" :cell-style="{fontSize: '12px'}" :data="roleInfoList" class="list-table" tooltip-effect="dark">
    ...
    <el-dialog :visible.sync="showAuthorization" :show-close="false" title="权限管理">
      ...
      <el-table :header-cell-style="{background:'#f7f7f7', color:'#333333', fontWeight: 'bold'}" :cell-style="{fontSize: '12px'}" :data="authorizationList" class="list-table" tooltip-effect="dark">
