        ...
        <el-row :gutter="34" class="basic-container">
          <el-col :span="13" class="part">
            <div class="role-detail">
              <div v-if="roleData" class="detail-top">
              ...
              <div class="user-content">
                ...
                <el-table :header-cell-style="{background:'#f7f7f7', color:'#333333', fontWeight: 'bold'}" :cell-style="{fontSize: '12px'}" :data="userList" class="user-table" tooltip-effect="dark" current-row-key="id" height="200">
                  <el-table-column label=" " align="center" type="index" width="50" />
                  <el-table-column label="账号" width="85" prop="username" show-overflow-tooltip>
                    <template slot-scope="scope">
                      <span v-if="!scope.row.username">-</span>
                      <el-button v-else :disabled="btnPermissions.indexOf('100000101') == -1" size="small" type="text" @click.native.prevent="handleUserDetail(scope.row.id)">{{ scope.row.username }}</el-button>
                    </template>
                  </el-table-column>
                  <el-table-column label="单位名称" prop="realName" show-overflow-tooltip>
                    <template slot-scope="scope">
            ...
            <div class="role-tree">
              ...
              <div class="tree-parent">
                <el-scrollbar class="role-scroll">
                  <el-tree ref="hbRoleTree" :data="roleTreeList" :props="props1" :node-key="props1.value" class="tree-content" default-expand-all />
                </el-scrollbar>
              </div>
            </div>
          </el-col>
