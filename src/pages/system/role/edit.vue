  ...
  <div class="hb-role-edit">
    ...
    <div class="hb-main-container">
      <div class="hb-main-content role-container">
        <el-form ref="roleEditForm" :model="form" :rules="rules" class="role-edit-form" label-width="100px" hide-required-asterisk>
            ...
            <el-col :span="13" class="part">
              <el-scrollbar class="role-detail">
                ...
                <el-form-item label="角色名称：" prop="roleName" class="padding-item">
                  <el-input :maxlength="15" v-model="form.roleName" size="small" class="reset-input" placeholder="请输入角色名称" />
                </el-form-item>
                <el-form-item label="描述：" prop="description" class="padding-item">
                  <el-input :maxlength="60" v-model="form.description" size="small" class="reset-input" placeholder="请输入角色描述" />
                </el-form-item>
                <div class="common-title">
                  <i class="descri" />
                ...
                <el-form-item label="代理商" class="avatar-item">
                  <div v-for="i in [1, 2, 3, 4, 5]" :key="i" :class="{active: i == form.icon}" :style="{borderColor: i == form.icon ? colorList[0] : ''}" class="avatar" @click="handleClickAvatar(i)">
                    <img :src="require('../../../../static/images/roleIcon/' + i + '.png')">
                    <i v-if="i == form.icon" :style="{backgroundColor: colorList[0]}" class="iconfont icon-pass" />
                  </div>
                </el-form-item>
                <el-form-item label="医院" class="avatar-item">
                  <div v-for="i in [6, 7, 8, 9, 10]" :key="i" :class="{active: i == form.icon}" :style="{borderColor: i == form.icon ? colorList[1] : ''}" class="avatar" @click="handleClickAvatar(i)">
                    <img :src="require('../../../../static/images/roleIcon/' + i + '.png')">
                    <i v-if="i == form.icon" :style="{backgroundColor: colorList[1]}" class="iconfont icon-pass" />
                  </div>
                </el-form-item>
                <el-form-item label="驾校" class="avatar-item">
                  <div v-for="i in [11, 12, 13, 14, 15]" :key="i" :class="{active: i == form.icon}" :style="{borderColor: i == form.icon ? colorList[2] : ''}" class="avatar" @click="handleClickAvatar(i)">
                    <img :src="require('../../../../static/images/roleIcon/' + i + '.png')">
                    <i v-if="i == form.icon" :style="{backgroundColor: colorList[2]}" class="iconfont icon-pass" />
                  </div>
                </el-form-item>
                <el-form-item label="公司" class="avatar-item">
                  <div v-for="i in [16, 17, 18, 19, 20]" :key="i" :class="{active: i == form.icon}" :style="{borderColor: i == form.icon ? colorList[3] : ''}" class="avatar" @click="handleClickAvatar(i)">
                    <img :src="require('../../../../static/images/roleIcon/' + i + '.png')">
                    <i v-if="i == form.icon" :style="{backgroundColor: colorList[3]}" class="iconfont icon-pass" />
                  </div>
                </el-form-item>
                <el-form-item label="其他" class="avatar-item">
                  <div v-for="i in [21, 22, 23, 24, 25]" :key="i" :class="{active: i == form.icon}" :style="{borderColor: i == form.icon ? colorList[4] : ''}" class="avatar" @click="handleClickAvatar(i)">
                    <img :src="require('../../../../static/images/roleIcon/' + i + '.png')">
                    <i v-if="i == form.icon" :style="{backgroundColor: colorList[4]}" class="iconfont icon-pass" />
                  </div>
                </el-form-item>
              </el-scrollbar>
            </el-col>
              ...
              <div class="role-tree">
                ...
                <div class="tree-parent">
                  <el-scrollbar class="role-scroll">
                    <el-tree ref="hbRoleTree" :check-strictly="true" :data="roleTreeList" :props="props1" :node-key="props1.value" class="tree-content" show-checkbox default-expand-all @check="roleTreeChange" />
                  </el-scrollbar>
                </div>
              </div>
            </el-col>
        ...
        <div class="operator-container">
          <el-button :disabled="disableSubmit" :loading="saveLoading" type="primary" @click="handleRoleSave">确定</el-button>
...
export default {
  ...
  data() {
    ...
    return {
      colorList: ['#45acf3', '#2fcaff', '#D0C092', '#fdc449', '#666666'], // 角色颜色列表
      roleId: '',
      saveLoading: false,
      disableSubmit: false,
      form: {
