<template>
  <div class="hb-user-detail">
      ...
      <div class="hb-main-content flex flex-column">
        <div :class="['user-info-con', {'max-height': !arrowPackUp, 'min-height': arrowPackUp}]">
          <span class="arrow-con" @click="changeArrowPackUp">
            <i :class="['iconfont', {'icon-xiangshang': !arrowPackUp, 'icon-dropdown': arrowPackUp}] "></i>
          </span>
          <el-form :inline="true" :class="{'max-form': !arrowPackUp, 'min-form': arrowPackUp}" label-width="100px">
            ...
            <el-form-item label="所属上级：" v-show="form.type != 1">
          ...
          <div class="sign-info">
            <div class="sign-info-row" v-show="!arrowPackUp">
            ...
            <div class="sign-info-row" v-show="!arrowPackUp">
              <el-popover
                ...
                <img slot="reference" v-if="form.userSign" :src="form.userSign" class="sign-img" alt="">
              </el-popover>
              <el-popover
                placement="left-start"
                popper-class="popper-img"
                ...
                <img slot="reference" v-if="form.orgSign" :src="form.orgSign" class="sign-img" alt="">
              </el-popover>
            </div>
          ...
          <div class="user-child-opearea">
            <div class="user-child-opearea-left">
              <el-input
                ...
                class="search-input reset-input header-search"
                placeholder="请输入子账号或姓名"
                clearable
                @clear="handleSearch"
                v-model="search"
              ...
              <el-select v-model="subAccountStatus" @change="handleSubAccountStatusStatus" size="small" class="ml15 reset-input tag-status" multiple placeholder="请选择账号状态">
                <el-option
            ...
            <div class="user-child-opearea-right">
              <el-button
                ...
                v-if="btnPermissions.indexOf('100000105') != -1"
                @click="handleCreateSubAccount">新建子账号</el-button>
            </div>
          </div>
          <div class="user-child-list">
            <el-table
              ref="subAccountListTable"
              class="list-table"
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  <el-switch :disabled="btnPermissions.indexOf('100000109') == -1" v-model="scope.row.status" class="status-switch" active-text="开" inactive-text="关" :active-value="1" :inactive-value="0" @change="handleChangeStatus(scope.row.id, scope.row.status)"></el-switch>
                </template>
              </el-table-column>
              <el-table-column
                prop="username"
    ...
    <el-dialog
      ...
      @click.native.prevent="handleShowResetPassword(scope.row.id)"
      width="428px">
      <el-form class="reset-password" ref="resetPasswordForm" :model="resetPasswordForm">
        <el-form-item id="loginState" class="childrenUserEditPassword" label="新密码：" prop="resetPassword" :rules="[
          { required:true, validator: validatePassword, trigger: 'change' }
        ]">
          <el-input size="small" show-password :maxlength="16" @blur="loginFocusState=false"  @focus="changeFocus" v-model="resetPasswordForm.resetPassword" placeholder="请输入新密码（6-12位字母或数字）"></el-input>
...
import { getUserById, subAccountPageList, userResetPassword, userToggleStatus } from '@/api/user.js'
