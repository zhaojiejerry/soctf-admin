          ...
          <div class="subaccount-info">
            <el-form ref="subAccountEditForm" :model="subAccountForm" label-width="100px" hide-required-asterisk>
              ...
              <el-form-item label="个人签章：">
                <el-image :src="subAccountForm.userSign" class="sign-container sub-sign-info" fit="fill">
          ...
          <div class="subaccount-limits">
            ...
            <div class="tree-parent">
              <el-scrollbar class="role-scroll">
                <el-tree ref="hbRoleTree" :check-strictly="true" :data="permList" :props="props1" :node-key="props1.value" class="tree-content" default-expand-all />
              </el-scrollbar>
            </div>
          </div>
        </div>
        <div class="button-con">
          <el-button v-if="isPersonalCenter" :loading="saveLoading" type="primary" size="small" @click="handleEditSubAcount">编辑信息</el-button>
          <el-button v-if="!isPersonalCenter && btnPermissions.indexOf('100000108') != -1" :loading="saveLoading" type="primary" size="small" @click="handleEditSubAcount">编辑子账号</el-button>
        </div>
      </div>
    </div>
  </div>
